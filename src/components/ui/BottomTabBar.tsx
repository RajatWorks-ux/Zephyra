...
// Height of the tab bar's own content (icon + label + paddings), NOT
// including the device safe-area inset (which BottomTabBar adds itself via
// `insets.bottom`). Screens that render content underneath the floating tab
// bar should clear it by `insets.bottom + TAB_BAR_CONTENT_HEIGHT` (plus a
// little breathing room) so nothing sits hidden behind it.
