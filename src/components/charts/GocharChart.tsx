...
export function KundliGrid({ cells, chartSize, centerContent, onCellPress }: KundliGridProps) {
  ...
  return (
    <View style={[grid.container, { width: chartSize, height: chartSize }]}>
      ...
      <View style={grid.row}>
        {renderCell(10)}
        <View style={{ width: CENTER_SIZE, height: CELL, alignItems: 'center', justifyContent: 'center' }}>
          {centerContent}
        </View>
        {renderCell(3)}
      </View>
...
const gc = StyleSheet.create({
  ...
  houseNum: { position: 'absolute', top: 4, right: 4, fontFamily: 'Orbitron_400Regular', fontSize: 9, opacity: 0.8 },
  ...
  abbrNatal: { fontFamily: 'Orbitron_400Regular', fontSize: 7, color: '#C9A84C' },
  glyphTransit: { fontSize: 11, color: '#2FBEBE' },
  abbrTransit: { fontFamily: 'Orbitron_400Regular', fontSize: 7, color: '#2FBEBE' },
...
const grid = StyleSheet.create({
  container: { overflow: 'hidden', borderRadius: 6, backgroundColor: 'rgba(10,5,25,0.6)' },
...
const styles = StyleSheet.create({
  ...
  legendTitle: { fontFamily: 'CinzelDecorative_400Regular', fontSize: 9, color: '#C9A84C', textTransform: 'uppercase' },
  legendTitleGochar: { fontFamily: 'CinzelDecorative_400Regular', fontSize: 9, color: '#2FBEBE', textTransform: 'uppercase' },
  legendSub: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 10, color: 'rgba(255,255,255,0.5)' },
  ...
  centerLabel: { fontFamily: 'CinzelDecorative_400Regular', fontSize: 9, color: '#2FBEBE', letterSpacing: 3 },
  centerDate: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 10, color: 'rgba(232,232,255,0.6)', marginTop: 2 },
  ...
  tileText: { fontFamily: 'CormorantGaramond_400Regular_Italic', fontSize: 14, color: '#B0B0D0', flex: 1, flexWrap: 'wrap', lineHeight: 20 },
  tileBadge: { position: 'absolute', top: 12, right: 12, fontFamily: 'Orbitron_400Regular', fontSize: 8, color: 'rgba(255,255,255,0.3)' },
});
