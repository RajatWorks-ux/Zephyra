          ...
          <Animated.View style={{ opacity: opacityInterpolate, transform: [{ scale: wheelScaleAnim }] }}>
            <Svg width={SIZE} height={SIZE}>
              ...
              <G rotation={armAngle} origin={`${CX},${CY}`}>
                {/* Dashed stick from center to knob bottom */}
                <Line
                  x1={CX} y1={CY - CENTER_R - 6}
                  x2={CX} y2={CY - KNOB_DIST + KNOB_R + 1}
                ...
                <Polygon
                  points={`${CX},${CY - KNOB_DIST - KNOB_R - 5} ${CX - 4},${CY - KNOB_DIST - KNOB_R + 3} ${CX + 4},${CY - KNOB_DIST - KNOB_R + 3}`}
                  fill="#C9A84C"
                  opacity={0.85}
                />
              </G>
