...
//     forecastStore.ts) via nvidia/nemotron-3-super-120b-a12b.
          ...
          {step === 1 && (
            <View style={styles.body}>
              ...
              <Text style={styles.sub}>
                Zephyra runs on NVIDIA's free NIM AI — powered by Nemotron 3 Super, a fast, genius-grade model. You need 1 key — it's free, no credit card. Your key stays on your device, encrypted. Never shared.
              </Text>
