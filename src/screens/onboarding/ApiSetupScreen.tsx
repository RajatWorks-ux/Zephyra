...
// ─────────────────────────────────────────────────────────────────────────────
// PHASE 3: 3-step setup wizard
// Step 1: OpenRouter Key + QR code
...
// qr-openrouter.png → links to your OpenRouter tutorial / openrouter.ai/keys
...
export function ApiSetupScreen() {
  ...
  const handleTestKey = async () => {
    ...
    if (!k.startsWith('sk-or-')) { setKeyError('Must start with sk-or-'); return }
  ...
  // ── Save OpenRouter key and advance ─────────────────────────────────────────
          ...
          {step === 1 && (
            <View style={styles.body}>
              ...
              <Text style={styles.sub}>
                Zephyra runs on OpenRouter's free AI. You need 1 key — it's free, no credit card. Your key stays on your device, encrypted. Never shared.
              </Text>
              ...
              <View style={styles.qrRow}>
                ...
                <View style={styles.qrInstructions}>
                  ...
                  <Text style={styles.qrStep}>{'→  Go to openrouter.ai/keys'}</Text>
                  <Text style={styles.qrStep}>{'→  Create free account'}</Text>
                  <Text style={styles.qrStep}>{'→  Click Create Key'}</Text>
