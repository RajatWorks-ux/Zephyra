...
// API keys (OpenRouter + NVIDIA) are stored in the device's secure hardware
// vault (iOS Keychain / Android Keystore). This is the most secure place to
// store them — they are never uploaded to any server, never in the cloud.
...
//   Step 1: OpenRouter key + QR + explanation
...
export function NewDeviceApiSetupScreen() {
  ...
  const testKey = async () => {
    ...
    if (!k.startsWith('sk-or-')) { setErr('Key must start with sk-or-'); return }
            ...
            <View style={styles.body}>
              ...
              <BlurView intensity={10} tint="dark" style={styles.explainBox}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.explainText}>
                    Your API key is stored inside this device's secure hardware chip — the same place your bank apps store passwords. This means it is{' '}
              ...
              <View style={styles.qrRow}>
                {QR_OPENROUTER
                  ...
                  : <View style={styles.qrBox}><Text style={styles.qrBoxText}>QR{'\n'}OpenRouter</Text></View>
                }
                <View style={{ flex: 1 }}>
                  <Text style={styles.qrTitle}>Scan for OpenRouter guide</Text>
                  <Text style={styles.qrStep}>{'→  openrouter.ai/keys'}</Text>
                  <Text style={styles.qrStep}>{'→  Create Key'}</Text>
                  <Text style={styles.qrStep}>{'→  Name it anything'}</Text>
                  <Text style={styles.qrStep}>{'→  Keys start with sk-or-'}</Text>
                </View>
              </View>
