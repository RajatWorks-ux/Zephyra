...
const styles = StyleSheet.create({
  ...
  inputWrap: {
    ...
    paddingVertical: 10, borderTopWidth: 1, borderTopColor: 'rgba(201,168,76,0.1)',
    minHeight: 64,
  },
  input: {
  ...
  drawerHeader: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    padding: 20, paddingTop: 56, borderBottomWidth: 1, borderBottomColor: 'rgba(201,168,76,0.1)',
  },
