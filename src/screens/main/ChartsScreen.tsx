...
import { buildChartContext } from '../../services/groqAI'
...
export function ChartsScreen() {
  ...
  // Derived — keeps rest of code readable
  const oracleVisible = oraclePayload?.visible ?? false
    ...
    <View style={styles.root}>
      ...
      {oraclePayload && (
        <ChartOracleModal
          ...
          onClose={() => setOraclePayload(p => p ? { ...p, visible: false } : null)}
