...
//   (nvidia/nemotron-3-super-120b-a12b), same single user-supplied key used
...
// site below (today/week/month/year) calls this one helper, so renaming it
// would mean touching 4 call sites for zero functional benefit.
