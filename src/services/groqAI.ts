...
// (isCompleteReading, extractReadingSeed, generateFullReading, getChartInsight follow)
...
export async function generateFullReading(
  ...
  // Chunks 1,3,5 use key1; chunks 2,4 use key2 (parallel, separate rate limit pools)
