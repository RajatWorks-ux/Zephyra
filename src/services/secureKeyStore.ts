...
export const KEY_GROQ_1 = 'zephyra_groq_key_1'
export const KEY_GROQ_2 = 'zephyra_groq_key_2'
...
// ── Test a GROQ key validity ──────────────────────────────────────────────────
export async function testGroqKey(key: string): Promise<{ valid: boolean; error?: string }> {
  try {
