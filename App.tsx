...
export default function App() {
  ...
  useEffect(() => {
    async function prepare() {
      ...
      prefetchAllVideos() // runs in background, no await

      // Register background daily reset task — wrapped in try/catch because
      // expo-background-fetch throws on simulators (no background fetch support)
      try {
